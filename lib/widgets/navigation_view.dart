...
class _NavigationView extends State<NavigationView> {
  ...
  void initState() {
    ...
    _currentPage = 0;  // Initial selected item is the first item
    super.initState();
  }

  @override
  Widget build(BuildContext context) {
    List<ItemNavigationView> reversedItems = widget.items.reversed.toList();
                  ...
                  return Stack(
                    children: [
                      AnimatedPositioned(
                        ...
                        left: (constraints.maxWidth / reversedItems.length) *
                            _currentPage,
                        width: constraints.maxWidth / reversedItems.length,
                        ...
                        child: Padding(
                          padding: EdgeInsets.only(
                              top: 5,
                              bottom: 0,
                              left: (45 / reversedItems.length),
                              right: (45 / reversedItems.length)),
                          child: InkWell(
                            onTap: () {},
                            child: Container(
                          ...
                          children: reversedItems
                            ...
                            child: InkWell(
                              onTap: () {
                                setState(() {
                                  _currentPage =
                                     reversedItems.indexOf(e);
                                  widget.onChangePage
                                      .call(reversedItems.indexOf(e));
                                });
                              },
